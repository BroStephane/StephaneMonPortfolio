...
namespace AnalyseFilm
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //nom du fichier XML
            string nomFichier = "F:/Kintzler/Bloc1_prog_Coppe/Chapitre_4/Partie 3/TP7/TP7/entrees-cine.xml";
            ...
            do
            {
                ...
                switch (option)
                {
                    case 1:
                        ...
                        {
                            Console.WriteLine("   " + unEle.nom);
                            Console.WriteLine("\tCe film a été passé " + unEle.nbSeance + " fois en " + unEle.mois + " " + unEle.annee);
                            Console.WriteLine("\tNombre de tickets vendus pour les enfants : " + unEle.nbEntEnfant);
                            Console.WriteLine("\tNombre de tickets vendus pour les adultes : " + unEle.nbEntAdulte);
                        }
                        Console.WriteLine("\nAppuyez sur entrée pour choisir une autre option");
                        Console.ReadLine();
                        break;
                    case 2:
                        ...
                        fichierFilm.Save("F:/Kintzler/Bloc1_prog_Coppe/Chapitre_4/Partie 3/TP7/TP7/entrees-cine.xml");
                    ...
                    case 3:
                        ...
                        foreach (CarFilm unEle in lesFilms)
                        {
                            nbSeancesTot = nbSeancesTot + unEle.nbSeance;
                        }

                        Console.WriteLine("Il y a en tout " + nbSeancesTot + " séances répertoriées sur le fichier XML");
                    ...
                    case 4:
                        ...
                        foreach (CarFilm unEle in lesFilms)
                        {
                            if (unEle.nbEntEnfant >= 100)
                            {
                                Console.WriteLine(unEle.nom + ", " + unEle.nbEntEnfant + " entrées enfants");
                                nbEntreesEnfant++;
                            }
                        }

                        Console.WriteLine("\n" + nbEntreesEnfant + " films on fait plus de 100 entrées enfants");
                    ...
                    case 5:
                        ...
                        foreach (CarFilm unEle in lesFilms)
                        {
                            if (unEle.mois == "décembre")
                            {
                                Console.WriteLine("\t" + unEle.nom);
                                nbFilmsDecembre++;
                            }
                        }
                        Console.WriteLine("\n" + nbFilmsDecembre + " films diffusés en décembre");
                    ...
                    case 6:
                        ...
                        Console.Write("Veuillez saisir le nom du mois (pas de majuscules, accents) : ");
                        nomMois = Console.ReadLine();

                        nbMois = 0;
                        foreach (CarFilm unEle in lesFilms)
                        {
                            if (unEle.mois == nomMois)
                            {
                                Console.WriteLine("\t" + unEle.nom + ", " + unEle.nbSeance + " séances");
                                nbMois++;
                            }
                        }

                        Console.WriteLine("\n" + nbMois + " films diffusés en " + nomMois);
